...
enum MM_EXTENSION {
	...
	EXT_VSKIP					= 1342,
	EXT_CAM_CAPABILITY_SKIP_CNT = 1343,
	EXT_CAM_CAPABILITY_RST_TIMESTAMP = 1344,
    EXT_CAM_CAPABILITY_LUT      = 1345,
    EXT_CAM_CAPABILITY_VFPN     = 1346, 
	EXT_DO_BPC					= 1400,
    EXT_VSUB_OFFSET             = 1401,
	EXT_DO_FFC					= 1402,
    EXT_CAM_CAPABILITY_CMV_FLIP = 1403,
	EXT_DO_CMS					= 1404,
};
