...
void xiAPIplus_Enumerators::Init()
{
	...
	XI_SENSOR_FEATURE_SELECTOR_ITEMS.push_back({"XI_SENSOR_FEATURE_PARALLEL_ADC",         5, "Sensor parallel ADC readout (on/off)"});
	...
	XI_SENSOR_FEATURE_SELECTOR_ITEMS.push_back({"XI_SENSOR_FEATURE_HIGH_CONVERSION_GAIN", 9, "Sensor high conversion gain (on/off)"});
