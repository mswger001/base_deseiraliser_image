#ifndef __DESERIALIZER_RS__
#define __DESERIALIZER_RS__
...
class DeserializerRealsense : public m2s2::ecal::deserializer::Deserializer
{
    public:
    DeserializerRealsense(
        std::string meas_path,
        std::string channel_name,
        std::string out_path
    );

    ~DeserializerRealsense() = default;
